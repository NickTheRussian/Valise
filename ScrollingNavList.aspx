<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScrollingNavList.aspx.cs" Inherits="Valise.ScrollingNavList" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Valise(Local DB)ConnectionString %>" SelectCommand="SELECT [colListContents] FROM [tbllist]"></asp:SqlDataSource>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Valise(Local DB)ConnectionString %>" SelectCommand="SELECT [colListContents] FROM [tbllist]"></asp:SqlDataSource>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Valise(Local DB)ConnectionString %>" SelectCommand="SELECT [colListContents] FROM [tbllist]"></asp:SqlDataSource>
